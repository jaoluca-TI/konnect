...
<head>
    ...
    <title>Perfil</title>
    <link rel="stylesheet" href="/konnect/frontend/css/perfil.css">
...
<section class="portfolio fade-in">
  <h3>Portfólio e Trabalhos Anteriores</h3>
  <div class="add-projeto">
    <input type="text" id="nomeProjeto" placeholder="Nome do projeto">
    <input type="url" id="linkProjeto" placeholder="Link do projeto (ex: https://meuprojeto.com)">
    <input type="file" id="imagemProjeto" accept="image/*">
    <button id="addProjeto">Adicionar Projeto</button>
  </div>
  <div id="listaProjetos" class="projetos-grid"></div>
</section>
